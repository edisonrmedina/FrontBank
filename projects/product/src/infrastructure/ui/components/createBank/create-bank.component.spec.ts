...
describe('ModalBankComponent', () => {
  ...
  it('should call CreateProductUseCase when submitting a new product', fakeAsync(() => {
    ...
    mockCreateProductUseCase.execute.and.returnValue(of(mockResponse));
    
    // Spy on closeModal emission
  ...
  it('should call UpdateProductUseCase when submitting in edit mode', fakeAsync(() => {
    // Set edit mode
    component.isEditMode = true;
    component.productToEdit = mockProduct;
    ...
    // Enable ID field for testing (it's disabled in edit mode)
    ...
    // Mock success response
    mockUpdateProductUseCase.execute.and.returnValue(of(mockResponse));
